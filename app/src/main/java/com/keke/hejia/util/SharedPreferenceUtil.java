...
public class SharedPreferenceUtil {
    ...
    //判断是否第一次进入程序
    public static void putFirst(Context context, boolean isSyn, String key, String first) {
        if (first == null) {
            return;
        }
    ...
    //取得第一次
    public static String getFirst(Context context, String key, String first) {
        SharedPreferences sp = context.getSharedPreferences(FILE_NAME, Context.MODE_MULTI_PROCESS);
        return sp.getString(key, first);
    }
